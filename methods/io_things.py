...
def add_random_perm_by_rock_type(some_rock_dict, ROCKS):
    '''
...
def tar_to_downscaled_models(path_to_models, nmodels, ROCKS, target_shape: tuple, fname='downscaled_models'):
    '''
        ...
        for tar in tqdm(tar_list):
            ...
            for g00_path, g12_path in tqdm(models_random_short_list):          
                try:
                    ...
                    rock_dict = add_random_perm_by_rock_type(rock_dict,  ROCKS) # add permeability
